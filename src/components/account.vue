                                ...
                                <v-container>
                                    <v-row>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem.olympic" label="奧林匹亞"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem.name" label="姓名"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem.email" label="帳號(信箱)"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem.password" label="密碼"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem.createday" label="建立時間"></v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
                            </v-card-text>
                ...
                this.desserts = [
                    {
                        ...
                        createday: '2006/07/06',
                    },
                    {
                        olympic: 'TOI',
                        name: '陳建年',
                        email: 'sandwich@gmail.com',
                        createday: '2006/05/22',
                    },
                    {
                        olympic: 'TOI',
                        name: '曾美莉',
                        email: 'Eclair@gmail.com',
                        createday: '2007/03/10',
                    },
                ]
            },

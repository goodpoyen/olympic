...
export default {
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? '新增考場' : '更改考場'
    }
  },
  ...
  methods: {
    ...
    async getSelections () {
      ...
      this.desserts = [
        { olyId: '3', areaId: 'A', olympic: 'TOI', areaName: '台大', signupName: '2022台灣資訊奧林匹亞初選選拔賽', address: '台北市大安區' },
        { olyId: '4', areaId: 'B', olympic: 'TOI', areaName: '台師大', signupName: '2022台灣資訊奧林匹亞初選選拔賽', address: '台北市大安區' }
      ]
